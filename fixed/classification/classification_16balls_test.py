...
def cal_acc(num, direction, speed):
    num1 = str(num)
    speed = str(speed)
    file = '/home/lab606a/ML/trajectories/fixed/classification/test/' + num1 + 'balls/' + direction + '_speed' +  speed + '_20200304_test.csv'
...
csv_path = '/home/lab606a/ML/trajectories/fixed/classification/test result/' + str(num_of_ball) + 'balls.csv'
df.to_csv(csv_path)
