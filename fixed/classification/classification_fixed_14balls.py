...
# read dataset
dataset = pd.read_csv('/home/lab606a/ML/trajectories/fixed/classification/dataset20200311_14balls.csv', header=None)
...
plt.savefig('./training history/14balls_accuracy.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('./training history/14balls_loss.png')

# saved model
model.save('./saved model/classifier_fixed_14balls')
