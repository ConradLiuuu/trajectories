...
# read dataset
dataset_path = '/home/lab606a/ML/trajectories/not_fixed/classification/datasets/dataset20200311_' + num_of_ball + 'balls.csv'
...
acc_png = './training history/' + num_of_ball + 'balls_accuracy.png'
plt.savefig(acc_png)
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
loss_png = './training history/' + num_of_ball + 'balls_loss.png'
plt.savefig(loss_png)

# saved model
model_path = './saved model/classifier_not_fixed_' + num_of_ball + 'balls'
